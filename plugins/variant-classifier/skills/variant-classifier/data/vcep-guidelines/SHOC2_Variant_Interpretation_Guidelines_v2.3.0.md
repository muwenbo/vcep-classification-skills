# ClinGen RASopathy Expert Panel Variant Interpretation Guidelines for SHOC2
...
| Attribute | Value |
|-----------|-------|
| **Gene** | SHOC2 (HGNC:15454) |
| **HGNC Name** | SHOC2 leucine rich repeat scaffold protein |
...
|----------|----------|-------------------|
| **Strong** | Same amino acid change as a previously established pathogenic variant in *SHOC2* regardless of nucleotide change. | Gene-specific |
...
**Comments:** Approved functional studies are available for each individual gene in the supplemental material. Additional functional studies can be submitted to the expert panel for approval. PS3 is not applicable for SHOC2 at this time.
...
| **Gene** | SHOC2 |
| **PMID** | 19684605 |
| **Assay Description** | Evaluate N-myristoylation by [3H]myristic acid (30uCi/ml) incorporation |
| **Material** | Wild type and mutant SHOC2 proteins transiently expressed in Cos-1 cells |
| **Readout Type** | Semi-quantitative (Qualitative) |
| **Readout Description** | Myristoylation status of p.S2G SHOC2 mutants versus WT and p.S2A SHOC2 mutant |
| **Biological Replicates** | Not met |
| **Technical Replicates** | Not met |
| **Basic Positive Control** | Met; WT |
| **Basic Negative Control** | Not met |
| **Validation Controls P/LP** | 1 (S2G) |
...
**Comments:** Not applicable. SHOC2-related RASopathy follows autosomal dominant inheritance.
...
**VCEP Specifications:** Applicable for observed analogous residue positions in *SHOC2*. PM1 and PM5 may be used in conjunction at moderate levels, however, PM1 may not be applied if PM5_Strong is applied to avoid overweighting.
...
Same point-based system as PS2 - see [PS2/PM6 Point System](#ps2pm6-point-system-per-proband) above.
...
**Comments:** Not applicable, see PS4. Phenotypic considerations are incorporated into the PS4 point-based scoring system.
...
| Criterion | Status | Available Strengths |
|-----------|--------|---------------------|
| PVS1 | Not Applicable | - |
...
| PM1 | Not Applicable | - |
| PM2 | Applicable (modified strength) | Supporting |
| PM3 | Not Applicable | - |
...
| Assay | General Description | Assay Specificity | Applicable to SHOC2? |
|-------|---------------------|-------------------|:--------------------:|
...
*This document was compiled from ClinGen RASopathy VCEP specifications for SHOC2 and ClinGen SVI recommendations. For the most current version, please refer to the ClinGen website.*
